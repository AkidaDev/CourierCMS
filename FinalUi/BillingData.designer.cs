...
namespace FinalUi
{
    ...
    partial void InsertStockAssignemnt(StockAssignemnt instance);
    partial void UpdateStockAssignemnt(StockAssignemnt instance);
    partial void DeleteStockAssignemnt(StockAssignemnt instance);
    ...
    partial void DeleteZONE(ZONE instance);
		...
		public BillingDataDataContext() : 
				base(global::FinalUi.Properties.Settings.Default.BillingDatabaseConnectionString1, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<StockAssignemnt> StockAssignemnts
		{
			get
			{
				return this.GetTable<StockAssignemnt>();
			}
		}
	...
	public partial class Employee : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<StockAssignemnt> _StockAssignemnts;
    ...
    partial void OnPasswordChanged();
		...
		public Employee()
		{
			this._StockAssignemnts = new EntitySet<StockAssignemnt>(new Action<StockAssignemnt>(this.attach_StockAssignemnts), new Action<StockAssignemnt>(this.detach_StockAssignemnts));
			this._Transactions = new EntitySet<Transaction>(new Action<Transaction>(this.attach_Transactions), new Action<Transaction>(this.detach_Transactions));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Employee_StockAssignemnt", Storage="_StockAssignemnts", ThisKey="Id", OtherKey="EmployeeId")]
		public EntitySet<StockAssignemnt> StockAssignemnts
		{
			get
			{
				return this._StockAssignemnts;
			}
			set
			{
				this._StockAssignemnts.Assign(value);
			}
		}
		...
		private void attach_StockAssignemnts(StockAssignemnt entity)
		{
			this.SendPropertyChanging();
			entity.Employee = this;
		}
		
		private void detach_StockAssignemnts(StockAssignemnt entity)
		{
			this.SendPropertyChanging();
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.StockAssignemnt")]
	public partial class StockAssignemnt : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnStockToChanging(string value);
    partial void OnStockToChanged();
    ...
    partial void OnDateChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_StockTo", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		public string StockTo
		{
			get
			{
				return this._StockTo;
			}
			set
			{
				if ((this._StockTo != value))
				{
					this.OnStockToChanging(value);
					this.SendPropertyChanging();
					this._StockTo = value;
					this.SendPropertyChanged("StockTo");
					this.OnStockToChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_StockFrom", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Employee_StockAssignemnt", Storage="_Employee", ThisKey="EmployeeId", OtherKey="Id", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._Employee.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.StockAssignemnts.Remove(this);
					}
					this._Employee.Entity = value;
					if ((value != null))
					{
						value.StockAssignemnts.Add(this);
