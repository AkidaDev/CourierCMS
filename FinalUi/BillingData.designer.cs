...
namespace FinalUi
{
    ...
    partial void InsertPermisstion(Permisstion instance);
    partial void UpdatePermisstion(Permisstion instance);
    partial void DeletePermisstion(Permisstion instance);
    ...
    partial void DeleteUser_Role(User_Role instance);
		...
		public System.Data.Linq.Table<Permisstion> Permisstions
		{
			get
			{
				return this.GetTable<Permisstion>();
			}
		}
    ...
    partial void OnpermisstionsChanging(string value);
    partial void OnpermisstionsChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_permisstions", DbType="VarChar(100) NOT NULL", CanBeNull=false)]
		public string permisstions
		{
			get
			{
				return this._permisstions;
			}
			set
			{
				if ((this._permisstions != value))
				{
					this.OnpermisstionsChanging(value);
					this.SendPropertyChanging();
					this._permisstions = value;
					this.SendPropertyChanged("permisstions");
					this.OnpermisstionsChanged();
				}
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Permisstion")]
	public partial class Permisstion : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Data.Linq.Binary _permisstion1;
    ...
    partial void OnidChanging(System.Guid value);
    partial void OnidChanged();
    partial void Onpermisstion1Changing(System.Data.Linq.Binary value);
    partial void Onpermisstion1Changed();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="permisstion", Storage="_permisstion1", DbType="VarBinary(50) NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		public System.Data.Linq.Binary permisstion1
		{
			get
			{
				return this._permisstion1;
			}
			set
			{
				if ((this._permisstion1 != value))
				{
					this.Onpermisstion1Changing(value);
					this.SendPropertyChanging();
					this._permisstion1 = value;
					this.SendPropertyChanged("permisstion1");
					this.Onpermisstion1Changed();
				}
			}
		}
