...
namespace FinalUi
{
    ...
    partial void OnPropertiesChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Quotation_Rule", Storage="_Quotation", ThisKey="ID", OtherKey="Id", IsForeignKey=true)]
    ...
    partial void OnCLCODEChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Quotation_Rule", Storage="_Rule", ThisKey="Id", OtherKey="ID", IsUnique=true, IsForeignKey=false)]
		public Rule Rule
		{
			get
			{
			...
			set
			{
							...
							|| (this._Rule.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Quotation = null;
					}
					this._Rule.Entity = value;
					if ((value != null))
					{
						value.Quotation = this;
					}
