...
namespace FinalUi
{
	...
	public partial class RuntimeData : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<double> _AcFrWeight;
    ...
    partial void OnAcFrWeightChanging(System.Nullable<double> value);
    partial void OnAcFrWeightChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AcFrWeight", DbType="Float")]
		public System.Nullable<double> AcFrWeight
		{
			get
			{
				return this._AcFrWeight;
			}
			set
			{
				if ((this._AcFrWeight != value))
				{
					this.OnAcFrWeightChanging(value);
					this.SendPropertyChanging();
					this._AcFrWeight = value;
					this.SendPropertyChanged("AcFrWeight");
					this.OnAcFrWeightChanged();
				}
			}
		}
